...
typedef signed __int64 zllong;
typedef unsigned __int64 zullong;
...
#define zc2zm(x) ((signed __int64)(x))
#define zs2zm(x) ((signed __int64)(x))
#define zi2zm(x) ((signed __int64)(x))
#define zl2zm(x) ((signed __int64)(x))
#define zll2zm(x) ((signed __int64)(x))
#define zm2zc(x) ((signed char)(x))
#define zm2zs(x) ((signed short)(x))
#define zm2zi(x) ((signed int)(x))
#define zm2zl(x) ((signed int)(x))
#define zm2zll(x) ((signed __int64)(x))
#define zuc2zum(x) ((unsigned __int64)(x))
#define zus2zum(x) ((unsigned __int64)(x))
#define zui2zum(x) ((unsigned __int64)(x))
#define zul2zum(x) ((unsigned __int64)(x))
#define zull2zum(x) ((unsigned __int64)(x))
...
#define zum2zull(x) ((unsigned __int64)(x))
#define zum2zm(x) ((signed __int64)(x))
#define zm2zum(x) ((unsigned __int64)(x))
...
#define zld2zm(x) ((signed __int64)dtcnv13f(x))
#define zm2zld(x) dtcnv13t((double)(x))
#define zld2zum(x) ((unsigned __int64)dtcnv13f(x))
#define zum2zld(x) dtcnv13t((double)(x))
#define zp2zum(x) ((unsigned __int64)(x))
#define zum2zp(x) ((unsigned int)(x))
#define l2zm(x) ((signed __int64)(x))
#define ul2zum(x) ((unsigned __int64)(x))
